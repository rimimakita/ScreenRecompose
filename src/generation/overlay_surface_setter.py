...
from generation.rule import amazon_recommend
...
def safe_set_overlay_surface(target_id, overlay_np, caption_text):
    ...
    with overlay_lock:
        for rect in stored_rectangles:
            ...
            target_width = amazon_recommend.get_overlay_width(rect)
            ...
            if len(rect.overlay_parts) == expected_count:
                ...
                rect.overlay_surface = amazon_recommend.build_overlay_surface(
                    rect.rect,
                    rect.overlay_parts,
                )
